# pyinstaller --onefile --noconsole -i"C:\icon.ico" --add-data C:\icon.ico;images C:\pySAgen_V1.2.py

from PyQt5 import QtCore, QtGui, QtWidgets
import os, math, re, sys, pkgutil
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        font_headline.setPointSize(10) # Mac 13
        font_headline.setBold(True)

        font_graphs = QtGui.QFont()
        font_graphs.setPixelSize(10) # Mac 10
        ...
        # Main Window
        MainWindow_size = [500, 811]  # Mac 500, 790
        ...
        self.__create_element(self.groupBox_th_vs_time, [5, 184, 490, 276], "groupBox_th_vs_time", title="")
        ...
        self.__create_element(self.groupBox_th_vs_s1hg_s2hg, [5, 491, 490, 276], "groupBox_th_vs_s1hg_s2hg", title="")
        ...
        self.__create_element(self.actionVersion, [999, 999, 999, 999], "actionVersion", text="Version 1.2")
