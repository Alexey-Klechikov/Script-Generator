...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.__create_element(self.groupBox_thVsTime, [5, 186-self.offset_os, 490, 274+self.offset_os], "groupBox_thVsTime", title="")
        ...
        self.__create_element(self.groupBox_thVsS1hgS2hg, [5, 493-self.offset_os, 490, 274+self.offset_os], "groupBox_thVsS1hgS2hg", title="")
        ...
        self.__create_element(self.action_version, [999, 999, 999, 999], "action_version", text="Version 1.1.1")
