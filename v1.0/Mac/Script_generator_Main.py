...
from Script_generator_FrontEnd import Ui_MainWindow as GUI_front_end
...
class GUI(GUI_front_end):
    ...
    def menu_info(self):
        ...
        msgBox.setText("SuperADAM Script generator V 1.0\n\n"
                       "Alexey.Klechikov@gmail.com\n\n"
                       "Check new version at https://github.com/Alexey-Klechikov/Script-Generator/releases")
        msgBox.exec_()
